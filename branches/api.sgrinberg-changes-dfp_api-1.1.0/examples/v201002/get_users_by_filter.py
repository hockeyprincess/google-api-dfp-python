...
"""This code example gets all users sorted by name. The filter retrieves up to
the maximum page size limit of 500. To create new users, run create_users.py."""
...
# Create filter object to get all users stored by name.
