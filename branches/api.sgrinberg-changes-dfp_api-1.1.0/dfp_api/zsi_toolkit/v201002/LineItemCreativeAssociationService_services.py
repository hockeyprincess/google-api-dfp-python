...
class LineItemCreativeAssociationServiceLocator:
    LineItemCreativeAssociationServiceInterface_address = "https://sandbox.google.com:443/apis/ads/publisher/v201002/LineItemCreativeAssociationService"
...
class LineItemCreativeAssociationServiceSoapBindingSOAP:
    ...
    # get: getLineItemCreativeAssociationsByFilter
    def getLineItemCreativeAssociationsByFilter(self, request):
        if isinstance(request, getLineItemCreativeAssociationsByFilterRequest) is False:
            raise TypeError, "%s incorrect request type" % (request.__class__)
        kw = {}
        # no input wsaction
        self.binding.Send(None, None, request, soapaction="", **kw)
        # no output wsaction
        response = self.binding.Receive(getLineItemCreativeAssociationsByFilterResponse.typecode)
        return response
...
getLineItemCreativeAssociationsByFilterRequest = ns0.getLineItemCreativeAssociationsByFilter_Dec().pyclass

getLineItemCreativeAssociationsByFilterResponse = ns0.getLineItemCreativeAssociationsByFilterResponse_Dec().pyclass
