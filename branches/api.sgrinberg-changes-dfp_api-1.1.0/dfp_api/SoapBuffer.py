...
from dfp_api import ETREE_NAME
from dfp_api import MIN_ETREE_VERSION
from dfp_api import MIN_PY_VERSION
from dfp_api import MIN_PYXML_VERSION
from dfp_api import PYXML
from dfp_api import PYXML_NAME
from dfp_api import Utils
from dfp_api.Buffer import Buffer
from dfp_api.Errors import InvalidInputError
from dfp_api.Errors import MalformedBufferError
...
class SoapBuffer(Buffer):
  ...
  def GetSOAPOut(self):
    ...
    for mask in ['authToken', 'ns1:authToken']:
  ...
  def GetServiceName(self):
    ...
    elements in the caller stack (e.g., CompanyService.Get() ->
