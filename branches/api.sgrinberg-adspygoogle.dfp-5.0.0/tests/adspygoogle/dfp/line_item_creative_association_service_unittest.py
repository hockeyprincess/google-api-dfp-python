...
class LicaServiceTestV201101(unittest.TestCase):

  """Unittest suite for LineItemCreativeAssociationService using V201101."""
...
class LicaServiceTestV201103(unittest.TestCase):

  """Unittest suite for LineItemCreativeAssociationService using V201103."""
...
def makeTestSuiteV201101():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(LicaServiceTestV201101))
  return suite
...
def makeTestSuiteV201103():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(LicaServiceTestV201103))
  return suite
