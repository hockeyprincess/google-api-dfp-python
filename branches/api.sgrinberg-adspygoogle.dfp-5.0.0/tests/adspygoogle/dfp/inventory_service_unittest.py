...
class InventoryServiceTestV201010(unittest.TestCase):

  """Unittest suite for InventoryService using v201010."""
...
class InventoryServiceTestV201101(unittest.TestCase):

  """Unittest suite for InventoryService using v201101."""
...
def makeTestSuiteV201010():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(InventoryServiceTestV201010))
  return suite
...
def makeTestSuiteV201101():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(InventoryServiceTestV201101))
  return suite
