...
class OrderServiceTestV201010(unittest.TestCase):

  """Unittest suite for OrderService using v201010."""
...
class OrderServiceTestV201101(unittest.TestCase):

  """Unittest suite for OrderService using v201101."""
...
class OrderServiceTestV201103(unittest.TestCase):

  """Unittest suite for OrderService using v201103."""
...
def makeTestSuiteV201010():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(OrderServiceTestV201010))
  return suite
...
def makeTestSuiteV201101():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(OrderServiceTestV201101))
  return suite
...
def makeTestSuiteV201103():
  ...
  """
  suite = unittest.TestSuite()
  suite.addTests(unittest.makeSuite(OrderServiceTestV201103))
  return suite
