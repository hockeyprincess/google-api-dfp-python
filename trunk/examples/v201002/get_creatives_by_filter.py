...
"""This code example gets all image creatives. The filter retrieves up to the
...
# Create filter object to only select image creatives.
filter = {'text': 'WHERE creativeType = \'ImageCreative\' LIMIT 500'}

# Get creatives by filter.
creatives = creative_service.GetCreativesByFilter(filter)[0]['results']
