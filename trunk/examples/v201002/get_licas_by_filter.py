...
line item id. The filter retrieves up to the maximum page size limit of 500. To
create LICAs, run create_licas.py."""
...
# Create filter object to only select LICAs for the given line item id.
filter = {'text': 'WHERE lineItemId = \'%s\' LIMIT 500' % line_item_id}
