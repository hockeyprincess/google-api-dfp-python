...
class WebService(object):
  ...
  def CallMethod(self, method_name, params, service_name=None, loc=None,
    ...
    try:
      ...
      try:
        ...
        from dfp_api.zsi_toolkit import MessageHandler
        service = MessageHandler.GetServiceConnection(
            headers, config, self.__url, self.__op_config['http_proxy'],
            service_name, loc)
        request = MessageHandler.SetRequestParams(request, params)
  ...
  def CallRawMethod(self, soap_message):
    ...
    try:
      ...
      index = self.__url.find('www.google.com')
      if index > -1:
        http_header['host'] = 'www.google.com'
